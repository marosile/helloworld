        ...
        <div id = "divContainer">
            ...
            <div class="companyInfos">
                ...
                <div class="checksInfo2">
                    ...
                    <div class="infos">
                        <input type="text" name="salaryInfo" placeholder=" 연봉정보를 입력해주세요. (비공개 가능)" class="infoInputs">
                    </div>
                </div>
                <div class="checksInfo2">
                    <div class="imgCenter"><img src="/resources/images/greenCheck.png" class="greenChecks"></div>
                    <div class="infos"><input type="text" name="experiencePeriod" placeholder=" 요구 경력기간을 입력해주세요 (ex: 신입~5년차)" class="infoInputs"></div>
                </div>
            ...
            <div class="companyInfos">
                ...
                <div class="checksInfo2">
                    <div class="imgCenter"><img src="/resources/images/greenCheck.png" class="greenChecks"></div>
                    <div class="infos"><input type="text" name="workConditions" placeholder=" 출근 장소 여부를 입력해주세요.(ex: 재택, 사무실 출근)" class="infoInputs"></div>
                </div>
                <div class="checksInfo2">
                    <div class="imgCenter"><img src="/resources/images/greenCheck.png" class="greenChecks"></div>
                    <div class="infos">
                        <input type="text" name="employmentType" placeholder=" 고용 형태를 입력해주세요.(ex: 인턴, 계약직, 정규직)" class="infoInputs">
                    </div>
                </div>
            ...
            <div id="qualificationAndresponsibilities">
                ...
                <textarea name="workConditionsDetail" placeholder=" 근무조건을 작성해주세요. ( 🔥 ex : 주 5일 09:00 ~ 18:00시간 야근 X )" class="qualRespTextArea" id="qualrespTextArea2"></textarea>
