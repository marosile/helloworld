                    ...
                    <div class="P-body-category-area">
                        ...
                        <div class="P-body-category-purpose">
                            ...
                            <ul class="P-selectBox-purpose menuHidden">
                                ...
                                <li><button type="button" class="P-option-btn">서울전체</button></li>
                           
                                    <li><button type="button" class="P-option-btn" id="gangnam-gu" value="강남구">강남구</button></li>
                                    <li><button type="button" class="P-option-btn" id="gangdong-gu" value="강동구">강동구</button></li>
                                    <li><button type="button" class="P-option-btn" id="gangbuk-gu" value="강북구">강북구</button></li>
                                    <li><button type="button" class="P-option-btn" id="gangseo-gu" value="강서구">강서구</button></li>
                                    <li><button type="button" class="P-option-btn" id="gwanak-gu" value="관악구">관악구</button></li>
                                    <li><button type="button" class="P-option-btn" id="gwangjin-gu" value="광진구">광진구</button></li>
                                    <li><button type="button" class="P-option-btn" id="guro-gu" value="구로구">구로구</button></li>
                                    <li><button type="button" class="P-option-btn" id="geumcheon-gu" value="금천구">금천구</button></li>
                                    <li><button type="button" class="P-option-btn" id="nowon-gu" value="노원구">노원구</button></li>
                                    <li><button type="button" class="P-option-btn" id="dobong-gu" value="도봉구">도봉구</button></li>
                                    <li><button type="button" class="P-option-btn" id="dongdaemun-gu" value="동대문구">동대문구</button></li>
                                    <li><button type="button" class="P-option-btn" id="dongjak-gu" value="동작구">동작구</button></li>
                                    <li><button type="button" class="P-option-btn" id="mapo-gu" value="마포구">마포구</button></li>
                                    <li><button type="button" class="P-option-btn" id="seodaemun-gu" value="서대문구">서대문구</button></li>
                                    <li><button type="button" class="P-option-btn" id="seochogu" value="서초구">서초구</button></li>
                                    <li><button type="button" class="P-option-btn" id="seongdong-gu" value="성동구">성동구</button></li>
                                    <li><button type="button" class="P-option-btn" id="seongbuk-gu" value="성북구">성북구</button></li>
                                    <li><button type="button" class="P-option-btn" id="songpa-gu" value="송파구">송파구</button></li>
                                    <li><button type="button" class="P-option-btn" id="yangcheon-gu" value="양천구">양천구</button></li>
                                    <li><button type="button" class="P-option-btn" id="yeongdeungpo-gu" value="영등포구">영등포구</button></li>
                                    <li><button type="button" class="P-option-btn" id="yongsan-gu" value="용산구">용산구</button></li>
                                    <li><button type="button" class="P-option-btn" id="eunpyeong-gu" value="은평구">은평구</button></li>
                                    <li><button type="button" class="P-option-btn" id="jongno-gu" value="종로구">종로구</button></li>
                                    <li><button type="button" class="P-option-btn" id="jung-gu" value="중구">중구</button></li>
                                    <li><button type="button" class="P-option-btn" id="jungrang-gu" value="중랑구">중랑구</button></li>
                        ...
                        <div class="P-body-category-role">
                            ...
                            <ul class="P-selectBox-role menuHidden" id=P-selectBox-role"">
                                <li><button type="button" class="P-option-btn" id="front">프론트앤드</button>
                                </li>
